...
export default function PaymentForm(): JSX.Element {
  ...
  const yupSchema = Yup.object().shape({
    cardHolderName: Yup.string().required('Card holder name required').min(3, 'Please enter valid name'),
          ...
          return (
            <form onSubmit={handleSubmit}>
              <div className="w-100 mb-4" style={{ maxWidth: 300 }}>
                <img
                  ...
                  style={{
                    ...
                    width: '100%',
                    height: 'auto',
                    opacity: cardType === 'unknown' || cardType === 'amex' ? 1 : 0.2,
                  }}
                  src={amex}
                  alt="amex card"
                />
                <img
                  ...
                  style={{
                    ...
                    width: '100%',
                    height: 'auto',
                    opacity: cardType === 'unknown' || cardType === 'master' ? 1 : 0.2,
                  }}
                  src={mastercard}
                  alt="mastercard card"
                />
                <img
                  ...
                  style={{
                    ...
                    width: '100%',
                    height: 'auto',
                    opacity: cardType === 'unknown' || cardType === 'visa' ? 1 : 0.2,
                  }}
                  src={visa}
                  alt="visa card"
                />
              ...
              <div className="form-row">
                ...
                <ExpiryYear errors={errors} touched={touched} startYear={startYear} />
              </div>
              ...
              <div className="d-flex flex-row justify-content-between">
                ...
                <button className="w-100 btn btn-primary" style={{ maxWidth: 120 }} type="submit">
                  Pay
                </button>
              </div>
            </form>
